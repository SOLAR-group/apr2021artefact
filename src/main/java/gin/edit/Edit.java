...
import gin.edit.modifynode.ReplaceExpression;
import gin.edit.modifynode.SwapExpression;
 ...
 * <p>
 * Java fail: can't be abstract and static. If you want to be able to parse your patches from a string, you'll need to
 * implement this method public static Edit fromString(String description);
 * <p>
 * (this is needed for at least PatchAnalyser)
 *
 * <p>
 * Furthermore, every edit needs a (SourceFile,Random) constructor for the places that a new edit is created
 */
public abstract class Edit {
    ...
    /**
     * @param editType
     * @return edit classes for a given edit type; for line/statement/matched these are delete/copy/replace/swap (move
     * is excluded)
     */
    public static List<Class<? extends Edit>> getEditClassesOfType(EditType editType) {
        switch (editType) {
            ...
            case MODIFY_STATEMENT:
                return Arrays.asList(BinaryOperatorReplacement.class, UnaryOperatorReplacement.class, ReplaceExpression.class, SwapExpression.class);
            default:
